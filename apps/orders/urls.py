...
urlpatterns = [
    path('', order_list_view, name='order_list_view'),
    path('create/', order_create_view, name='order_create_view'),
    path('<int:pk>/', order_detail_view, name = 'order_detail_view'),
    path('<int:pk>/update/', order_update_destroy_view, name = 'order_update_destroy_view'),
    path('<int:pk>/delete/', order_update_destroy_view, name = 'order_update_destroy_view'),
]